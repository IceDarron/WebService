 ...
 * 
 */
@WebServiceClient(name = "ServiceHelloService", targetNamespace = "http://service.darron.com/", wsdlLocation = "http://localhost:10000/Service/ServiceHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEHELLOSERVICE_QNAME = new QName("http://service.darron.com/", "ServiceHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:10000/Service/ServiceHello?wsdl");
    ...
    public ServiceHello getServiceHelloPort() {
        return super.getPort(new QName("http://service.darron.com/", "ServiceHelloPort"), ServiceHello.class);
    }
    ...
    public ServiceHello getServiceHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.darron.com/", "ServiceHelloPort"), ServiceHello.class, features);
    }
