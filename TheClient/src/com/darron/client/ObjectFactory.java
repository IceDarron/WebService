 ...
 * generated in the com.darron.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValueResponse_QNAME = new QName("http://service.darron.com/", "getValueResponse");
    private final static QName _GetValue_QNAME = new QName("http://service.darron.com/", "getValue");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.darron.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.darron.com/", name = "getValueResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.darron.com/", name = "getValue")
